<template>
  <div>
    <h1 class="text-6xl">在线 HMAC-SHA256 加密</h1>
    ...
    <h3 class="text-2xl my-2">什么是 SHA-256 加密？</h3>
    <p>
    ...
    <h3 class="text-2xl my-2">SHA-256 加密安全吗？</h3>
...
export default {
  ...
  methods: {
    ...
    handleClick() {
      ...
      this.key2 = this.key;
      let output = cryptojs.HmacSHA256(this.input2, this.key2).toString();
      this.output = output;
