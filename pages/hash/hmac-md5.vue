<template>
  <div>
    <h1 class="text-6xl">在线HMAC-MD5加密</h1>
    ...
    <h3 class="text-2xl my-2">什么是HMAC？</h3>
    ...
    <h3 class="text-2xl my-2">什么是MD5加密？</h3>
    <p>
    ...
    <h3 class="text-2xl my-2">MD5加密有什么作用？</h3>
    <p>
    ...
    <h3 class="text-2xl my-2">MD5加密安全吗？</h3>
    <p>
...
export default {
  ...
  methods: {
    ...
    handleClick() {
      ...
      this.key2 = this.key;
      this.output = cryptoJs.HmacMD5(this.input2, this.key2);
