<template>
  <div class="contact">
    ...
    <form action="" @submit.prevent="doSend">
      ...
      <input name="name" type="text" id="js-name" class="w-64">
      <label class="block mt-2" for="js-email">邮箱</label>
      <input name="email" type="email" id="js-email" class="w-64">
      <label class="mt-2 block" for="js-content">内容</label>
      <textarea name="content" id="js-content" cols="30" rows="10" class="w-full"></textarea>
