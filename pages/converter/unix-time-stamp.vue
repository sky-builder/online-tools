<template>
  <div>
    <h1 class="text-6xl">在线unix时间戳转换</h1>
    <div>
      <span>当前时间：</span>
    ...
    <table class="mt-2">
      <tbody>
        <tr>
          ...
          <td class="border border-gray-300 p-2">
            <input type="tet" v-model="unixInput" class="border border-gray-500" />
          </td>
          <td class="border border-gray-300 p-2">
            <button class="bg-blue-500 hover:bg-blue-700 px-2 py-1 text-white" @click="unix2time">转换</button>
          </td>
          <td class="border border-gray-300 p-2">
            <span>时间</span>
          </td>
        ...
        <tr>
          ...
          <td class="border border-gray-300 p-2">
            <button class="bg-blue-500 hover:bg-blue-700 px-2 py-1 text-white" @click="time2unix">转换</button>
          </td>
          <td class="border border-gray-300 p-2">
